...
router.get('/JsonOfAllStreets', ensureAuth ,(req,res)=>{
  res.json([{name : "צ'רניכובסקי", id : 2040135469834},{name : `חז"ל`, id :1930135469834 }])
})
...
router.get('/JsonOfAllBuilding', ensureAuth ,(req,res)=>{
  ...
  res.json([{name : `1`, id : 2440135469834},{name : "2ב", id :1937135469834 }])
})
...
router.get('/JsonOfAllApartments', ensureAuth ,(req,res)=>{
  ...
  res.json([{name : `1` , id : 2056135469834},{name : `2` , id :1930879469834 }])
})
...
router.get('/JsonOfAllComments', ensureAuth ,(req,res)=>{
  ...
  res.json({apartmentComments:[{apartamentID : 1937135469834, postID : 1937135469834, startYear: 2019, endYear: 2020, apartamentText:"היה ממש בסדר האמתר שום דבר חשוד", rank : 8, rentCost : 2500, heshbonot : 450 },] , buildingComments:[{buildingId : 1937135469834, levelOfStudents : 3, buildingText:"יש משאית זבל ששומעים בבוקר, חוץ מזה כלום" , buildingRank : 6 }]})
})
